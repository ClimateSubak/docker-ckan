/*
  SimpleRange v1.0.0 | Repo: https://github.com/maxshuty/accessible-web-components/src/components/simpleRange.js
  By Max Poshusta | https://github.com/maxshuty | https://www.linkedin.com/in/maxposhusta/
*/

"use strict";

this.ckan.module("range_slider", function ($) {
  return {
    initialize: function () {
      var slider = this.el;

      console.log("initialised range_slider");

      // Object containing common CSS styles so we can change them in once place
      const cssHelpers = Object.freeze({
        sliderBackgroundColor: "#0f2b43",
        sliderBorderColor: "#c95e3b",
        sliderBorderRadius: "4px",
        sliderCircleSize: 20,
        sliderCircleBackgroundColor: "#ffffff",
        sliderCircleFocusColor: "#c95e3b",
      ...
      class SimpleRange extends HTMLElement {
        ...
        get numberOfLegendItemsToShow() {
          ...
          return numOfLegendItems && numOfLegendItems > 1
            ? numOfLegendItems
            : 2;
        }
        ...
        isValidRangeSelection(el, minValue, maxValue) {
          ...
          if (this.inputsForLabels) {
            const isMinInputEl = el.hasAttribute(
              constants.RANGE_INPUT_DATA_LABEL_MIN
            );
            if (isMinInputEl) {
              return (
